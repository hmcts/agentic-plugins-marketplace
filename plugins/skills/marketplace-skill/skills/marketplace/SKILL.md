---
name: marketplace
description: Use when the user asks to browse, search, or install marketplace plugins, or says something like "what plugins are available", "find me a database plugin", or "install the audit-log hook".
---
